...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/identity_group_member_group_ids
...
export class IdentityGroupMemberGroupIds extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityGroupMemberGroupIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/identity_group_member_group_ids#import import section} in the documentation of this resource for the id to use
