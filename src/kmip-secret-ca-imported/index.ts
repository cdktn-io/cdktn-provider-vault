...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/kmip_secret_ca_imported
...
export class KmipSecretCaImported extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmipSecretCaImported that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/kmip_secret_ca_imported#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/kmip_secret_ca_imported vault_kmip_secret_ca_imported} Resource
  *
  * @param scope The scope in which to define this construct
