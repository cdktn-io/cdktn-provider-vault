...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/sys_config_cors
...
export class SysConfigCors extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SysConfigCors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/sys_config_cors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/sys_config_cors vault_sys_config_cors} Resource
  *
  * @param scope The scope in which to define this construct
