...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/aws_auth_backend_role
...
export interface AwsAuthBackendRoleConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly resolveAwsUniqueIds?: boolean | cdktn.IResolvable;
  /**
  * Name of the role.
  *
...
*/
export class AwsAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/aws_auth_backend_role#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsAuthBackendRole to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_aws_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/aws_auth_backend_role vault_aws_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public get boundAccountIds() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_account_ids'));
  }
  ...
  public get boundAmiIds() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_ami_ids'));
  }
  ...
  public get boundEc2InstanceIds() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_ec2_instance_ids'));
  }
  ...
  public get boundIamInstanceProfileArns() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_iam_instance_profile_arns'));
  }
  ...
  public get boundIamPrincipalArns() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_iam_principal_arns'));
  }
  ...
  public get boundIamRoleArns() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_iam_role_arns'));
  }
  ...
  public get boundSubnetIds() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_subnet_ids'));
  }
  ...
  public get boundVpcIds() {
    return cdktn.Fn.tolist(this.getListAttribute('bound_vpc_ids'));
  }
  ...
  private _resolveAwsUniqueIds?: boolean | cdktn.IResolvable; 
  public get resolveAwsUniqueIds() {
    return this.getBooleanAttribute('resolve_aws_unique_ids');
  }
  public set resolveAwsUniqueIds(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bound_account_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundAccountIds),
      bound_ami_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundAmiIds),
      bound_ec2_instance_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundEc2InstanceIds),
      bound_iam_instance_profile_arns: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundIamInstanceProfileArns),
      bound_iam_principal_arns: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundIamPrincipalArns),
      bound_iam_role_arns: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundIamRoleArns),
      bound_regions: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundRegions),
      bound_subnet_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundSubnetIds),
      bound_vpc_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._boundVpcIds),
      disallow_reauthentication: cdktn.booleanToTerraform(this._disallowReauthentication),
      id: cdktn.stringToTerraform(this._id),
      inferred_aws_region: cdktn.stringToTerraform(this._inferredAwsRegion),
      inferred_entity_type: cdktn.stringToTerraform(this._inferredEntityType),
      namespace: cdktn.stringToTerraform(this._namespace),
      resolve_aws_unique_ids: cdktn.booleanToTerraform(this._resolveAwsUniqueIds),
      role: cdktn.stringToTerraform(this._role),
      role_tag: cdktn.stringToTerraform(this._roleTag),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      bound_account_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundAccountIds),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_ami_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundAmiIds),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_ec2_instance_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundEc2InstanceIds),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_iam_instance_profile_arns: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundIamInstanceProfileArns),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_iam_principal_arns: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundIamPrincipalArns),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_iam_role_arns: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundIamRoleArns),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      bound_subnet_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundSubnetIds),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      bound_vpc_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._boundVpcIds),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      inferred_aws_region: {
        value: cdktn.stringToHclTerraform(this._inferredAwsRegion),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      inferred_entity_type: {
        value: cdktn.stringToHclTerraform(this._inferredEntityType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      resolve_aws_unique_ids: {
        value: cdktn.booleanToHclTerraform(this._resolveAwsUniqueIds),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      role_tag: {
        value: cdktn.stringToHclTerraform(this._roleTag),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
