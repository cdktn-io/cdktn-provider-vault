...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/identity_oidc_key
...
export interface IdentityOidcKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class IdentityOidcKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityOidcKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/identity_oidc_key#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IdentityOidcKey to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_identity_oidc_key", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/identity_oidc_key vault_identity_oidc_key} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      verification_ttl: cdktn.numberToTerraform(this._verificationTtl),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      verification_ttl: {
        value: cdktn.numberToHclTerraform(this._verificationTtl),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
