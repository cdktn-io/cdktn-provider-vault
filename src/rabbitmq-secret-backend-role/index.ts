...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/rabbitmq_secret_backend_role
...
export class RabbitmqSecretBackendRoleVhostTopicOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _vhost = new RabbitmqSecretBackendRoleVhostTopicVhostList(this, "vhost", true);
  public get vhost() {
    return this._vhost;
  }
...
export class RabbitmqSecretBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RabbitmqSecretBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/rabbitmq_secret_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/rabbitmq_secret_backend_role vault_rabbitmq_secret_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // vhost - computed: false, optional: true, required: false
  private _vhost = new RabbitmqSecretBackendRoleVhostList(this, "vhost", true);
  public get vhost() {
    return this._vhost;
  }
  ...
  private _vhostTopic = new RabbitmqSecretBackendRoleVhostTopicList(this, "vhost_topic", true);
