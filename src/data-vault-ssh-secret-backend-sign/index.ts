...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/ssh_secret_backend_sign
...
export class DataVaultSshSecretBackendSign extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultSshSecretBackendSign that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/ssh_secret_backend_sign#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/ssh_secret_backend_sign vault_ssh_secret_backend_sign} Data Source
  *
  * @param scope The scope in which to define this construct
