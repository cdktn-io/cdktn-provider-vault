...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/activation_flags
...
export class ActivationFlags extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ActivationFlags that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/activation_flags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/activation_flags vault_activation_flags} Resource
  *
  * @param scope The scope in which to define this construct
