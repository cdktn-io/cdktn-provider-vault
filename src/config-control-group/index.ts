...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_control_group
...
export class ConfigControlGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigControlGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_control_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_control_group vault_config_control_group} Resource
  *
  * @param scope The scope in which to define this construct
