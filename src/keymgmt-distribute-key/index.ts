...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key
...
export interface KeymgmtDistributeKeyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#key_name KeymgmtDistributeKey#key_name}
  */
  readonly keyName: string;
  /**
  * Specifies the name of the KMS provider to distribute the given key to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#kms_name KeymgmtDistributeKey#kms_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#mount KeymgmtDistributeKey#mount}
  */
  readonly mount: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#namespace KeymgmtDistributeKey#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#protection KeymgmtDistributeKey#protection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#purpose KeymgmtDistributeKey#purpose}
  */
  readonly purpose: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key vault_keymgmt_distribute_key}
*/
export class KeymgmtDistributeKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KeymgmtDistributeKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_distribute_key vault_keymgmt_distribute_key} Resource
  *
  * @param scope The scope in which to define this construct
