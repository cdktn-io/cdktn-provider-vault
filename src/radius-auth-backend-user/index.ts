...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user
...
export interface RadiusAuthBackendUserConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user#mount RadiusAuthBackendUser#mount}
  */
  readonly mount: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user#namespace RadiusAuthBackendUser#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user#policies RadiusAuthBackendUser#policies}
  */
  readonly policies?: string[];
  /**
  * The username to register with the RADIUS auth backend.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user#username RadiusAuthBackendUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user vault_radius_auth_backend_user}
*/
export class RadiusAuthBackendUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RadiusAuthBackendUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/radius_auth_backend_user vault_radius_auth_backend_user} Resource
  *
  * @param scope The scope in which to define this construct
