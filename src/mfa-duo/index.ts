...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/mfa_duo
...
export class MfaDuo extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MfaDuo that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/mfa_duo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/mfa_duo vault_mfa_duo} Resource
  *
  * @param scope The scope in which to define this construct
