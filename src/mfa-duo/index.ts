...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/mfa_duo
...
export interface MfaDuoConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class MfaDuo extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the MfaDuo to import
  * @param importFromId The id of the existing MfaDuo that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/mfa_duo#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MfaDuo to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_mfa_duo", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/mfa_duo vault_mfa_duo} Resource
  *
  * @param scope The scope in which to define this construct
