...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/mfa_duo
...
export class MfaDuo extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MfaDuo that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/mfa_duo#import import section} in the documentation of this resource for the id to use
