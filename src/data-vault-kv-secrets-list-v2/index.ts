...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/data-sources/kv_secrets_list_v2
...
export class DataVaultKvSecretsListV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultKvSecretsListV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/data-sources/kv_secrets_list_v2#import import section} in the documentation of this resource for the id to use
