...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/kubernetes_secret_backend
...
export class KubernetesSecretBackend extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesSecretBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/kubernetes_secret_backend#import import section} in the documentation of this resource for the id to use
