...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes
...
export interface DataVaultPluginRuntimesConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes#namespace DataVaultPluginRuntimes#namespace}
  */
  readonly namespace?: string;
  /**
  * Specifies the plugin runtime type to list. Currently only `container` is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes#type DataVaultPluginRuntimes#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes vault_plugin_runtimes}
*/
export class DataVaultPluginRuntimes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultPluginRuntimes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/plugin_runtimes vault_plugin_runtimes} Data Source
  *
  * @param scope The scope in which to define this construct
