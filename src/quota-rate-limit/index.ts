...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_rate_limit
...
*/
export class QuotaRateLimit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaRateLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_rate_limit#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the QuotaRateLimit to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_quota_rate_limit", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_rate_limit vault_quota_rate_limit} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _inheritable?: boolean | cdktn.IResolvable; 
  public get inheritable() {
    return this.getBooleanAttribute('inheritable');
  }
  public set inheritable(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      block_interval: cdktn.numberToTerraform(this._blockInterval),
      group_by: cdktn.stringToTerraform(this._groupBy),
      id: cdktn.stringToTerraform(this._id),
      inheritable: cdktn.booleanToTerraform(this._inheritable),
      interval: cdktn.numberToTerraform(this._interval),
      name: cdktn.stringToTerraform(this._name),
      namespace: cdktn.stringToTerraform(this._namespace),
      path: cdktn.stringToTerraform(this._path),
      rate: cdktn.numberToTerraform(this._rate),
      role: cdktn.stringToTerraform(this._role),
      secondary_rate: cdktn.numberToTerraform(this._secondaryRate),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      block_interval: {
        value: cdktn.numberToHclTerraform(this._blockInterval),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      group_by: {
        value: cdktn.stringToHclTerraform(this._groupBy),
        isBlock: false,
        type: "simple",
      ...
      inheritable: {
        value: cdktn.booleanToHclTerraform(this._inheritable),
        isBlock: false,
        type: "simple",
      ...
      rate: {
        value: cdktn.numberToHclTerraform(this._rate),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      secondary_rate: {
        value: cdktn.numberToHclTerraform(this._secondaryRate),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
