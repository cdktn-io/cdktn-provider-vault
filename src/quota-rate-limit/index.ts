...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/quota_rate_limit
...
export class QuotaRateLimit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaRateLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/quota_rate_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/quota_rate_limit vault_quota_rate_limit} Resource
  *
  * @param scope The scope in which to define this construct
