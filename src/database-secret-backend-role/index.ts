...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/database_secret_backend_role
...
export class DatabaseSecretBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseSecretBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/database_secret_backend_role#import import section} in the documentation of this resource for the id to use
