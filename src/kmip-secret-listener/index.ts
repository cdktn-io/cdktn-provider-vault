...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener
...
export interface KmipSecretListenerConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#additional_client_cas KmipSecretListener#additional_client_cas}
  */
  readonly additionalClientCas?: string[];
  /**
  * Host:port address to listen on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#address KmipSecretListener#address}
  */
  readonly address: string;
  /**
  * Use the legacy unnamed CA for verifying client certificates as well.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#also_use_legacy_ca KmipSecretListener#also_use_legacy_ca}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#ca KmipSecretListener#ca}
  */
  readonly ca: string;
  /**
  * Unique name for the listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#name KmipSecretListener#name}
  */
  readonly name: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#namespace KmipSecretListener#namespace}
  */
  readonly namespace?: string;
  /**
  * Path where KMIP backend is mounted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#path KmipSecretListener#path}
  */
  readonly path: string;
  /**
  * DNS SANs to include in listener certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#server_hostnames KmipSecretListener#server_hostnames}
  */
  readonly serverHostnames?: string[];
  /**
  * IP SANs to include in listener certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#server_ips KmipSecretListener#server_ips}
  */
  readonly serverIps?: string[];
  /**
  * TLS cipher suites to allow (does not apply to tls13+).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#tls_cipher_suites KmipSecretListener#tls_cipher_suites}
  */
  readonly tlsCipherSuites?: string;
  /**
  * Maximum TLS version to accept (tls12 or tls13).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#tls_max_version KmipSecretListener#tls_max_version}
  */
  readonly tlsMaxVersion?: string;
  /**
  * Minimum TLS version to accept (tls12 or tls13).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#tls_min_version KmipSecretListener#tls_min_version}
  */
  readonly tlsMinVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener vault_kmip_secret_listener}
*/
export class KmipSecretListener extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmipSecretListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_listener vault_kmip_secret_listener} Resource
  *
  * @param scope The scope in which to define this construct
