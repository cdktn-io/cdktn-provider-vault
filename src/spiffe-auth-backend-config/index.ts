...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_config
...
*/
export class SpiffeAuthBackendConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SpiffeAuthBackendConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_spiffe_auth_backend_config", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_config vault_spiffe_auth_backend_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public set deferBundleFetch(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      bundle: {
        value: cdktn.stringToHclTerraform(this._bundle),
        isBlock: false,
        type: "simple",
      ...
      endpoint_root_ca_truststore_pem: {
        value: cdktn.stringToHclTerraform(this._endpointRootCaTruststorePem),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      endpoint_spiffe_id: {
        value: cdktn.stringToHclTerraform(this._endpointSpiffeId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
