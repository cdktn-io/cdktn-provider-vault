...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/managed_keys
...
export interface ManagedKeysConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly gcp?: ManagedKeysGcp[] | cdktn.IResolvable;
  /**
  * pkcs block
  *
...
export interface ManagedKeysGcp {
  /**
...
export function managedKeysGcpToTerraform(struct?: ManagedKeysGcp | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    crypto_key: cdktn.stringToTerraform(struct!.cryptoKey),
    crypto_key_version: cdktn.stringToTerraform(struct!.cryptoKeyVersion),
    key_ring: cdktn.stringToTerraform(struct!.keyRing),
    name: cdktn.stringToTerraform(struct!.name),
...
export function managedKeysGcpToHclTerraform(struct?: ManagedKeysGcp | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    crypto_key: {
      value: cdktn.stringToHclTerraform(struct!.cryptoKey),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    crypto_key_version: {
      value: cdktn.stringToHclTerraform(struct!.cryptoKeyVersion),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ManagedKeysGcpOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): ManagedKeysGcp | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    ...
    if (this._cryptoKeyVersion !== undefined) {
      hasAnyValues = true;
      internalValueResult.cryptoKeyVersion = this._cryptoKeyVersion;
    }
  ...
  public set internalValue(value: ManagedKeysGcp | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      ...
      this._cryptoKeyVersion = undefined;
      ...
      this._cryptoKeyVersion = value.cryptoKeyVersion;
  ...
  // crypto_key_version - computed: true, optional: true, required: false
...
export class ManagedKeysGcpList extends cdktn.ComplexList {
  public internalValue? : ManagedKeysGcp[] | cdktn.IResolvable
  ...
  */
  public get(index: number): ManagedKeysGcpOutputReference {
    return new ManagedKeysGcpOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function managedKeysPkcsToTerraform(struct?: ManagedKeysPkcs | cdktn.IResolvable): any {
  ...
  return {
    ...
    max_parallel: cdktn.numberToTerraform(struct!.maxParallel),
...
export function managedKeysPkcsToHclTerraform(struct?: ManagedKeysPkcs | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    max_parallel: {
      value: cdktn.numberToHclTerraform(struct!.maxParallel),
      isBlock: false,
      type: "simple",
...
export class ManagedKeysPkcsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // max_parallel - computed: true, optional: true, required: false
...
export class ManagedKeys extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/managed_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/managed_keys vault_managed_keys} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _gcp = new ManagedKeysGcpList(this, "gcp", true);
  public get gcp() {
    return this._gcp;
  }
  public putGcp(value: ManagedKeysGcp[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      gcp: cdktn.listMapper(managedKeysGcpToTerraform, true)(this._gcp.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      gcp: {
        value: cdktn.listMapperHcl(managedKeysGcpToHclTerraform, true)(this._gcp.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ManagedKeysGcpList",
      },
      pkcs: {
