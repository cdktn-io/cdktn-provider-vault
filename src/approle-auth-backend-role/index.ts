...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_role
...
export interface ApproleAuthBackendRoleConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly bindSecretId?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly localSecretIds?: boolean | cdktn.IResolvable;
  /**
...
*/
export class ApproleAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApproleAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_approle_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_role vault_approle_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ApproleAuthBackendRoleConfig) {
    ...
    this._id = config.id;
    this._localSecretIds = config.localSecretIds;
  ...
  private _bindSecretId?: boolean | cdktn.IResolvable; 
  public get bindSecretId() {
    return this.getBooleanAttribute('bind_secret_id');
  }
  public set bindSecretId(value: boolean | cdktn.IResolvable) {
  ...
  // local_secret_ids - computed: false, optional: true, required: false
  private _localSecretIds?: boolean | cdktn.IResolvable; 
  public get localSecretIds() {
    return this.getBooleanAttribute('local_secret_ids');
  }
  public set localSecretIds(value: boolean | cdktn.IResolvable) {
    this._localSecretIds = value;
  }
  public resetLocalSecretIds() {
    this._localSecretIds = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get localSecretIdsInput() {
    return this._localSecretIds;
  }
  ...
  public get secretIdBoundCidrs() {
    return cdktn.Fn.tolist(this.getListAttribute('secret_id_bound_cidrs'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bind_secret_id: cdktn.booleanToTerraform(this._bindSecretId),
      id: cdktn.stringToTerraform(this._id),
      local_secret_ids: cdktn.booleanToTerraform(this._localSecretIds),
      namespace: cdktn.stringToTerraform(this._namespace),
      role_id: cdktn.stringToTerraform(this._roleId),
      role_name: cdktn.stringToTerraform(this._roleName),
      secret_id_bound_cidrs: cdktn.listMapper(cdktn.stringToTerraform, false)(this._secretIdBoundCidrs),
      secret_id_num_uses: cdktn.numberToTerraform(this._secretIdNumUses),
      secret_id_ttl: cdktn.numberToTerraform(this._secretIdTtl),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      bind_secret_id: {
        value: cdktn.booleanToHclTerraform(this._bindSecretId),
        isBlock: false,
        type: "simple",
      ...
      local_secret_ids: {
        value: cdktn.booleanToHclTerraform(this._localSecretIds),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      secret_id_bound_cidrs: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._secretIdBoundCidrs),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      secret_id_num_uses: {
        value: cdktn.numberToHclTerraform(this._secretIdNumUses),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      secret_id_ttl: {
        value: cdktn.numberToHclTerraform(this._secretIdTtl),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
