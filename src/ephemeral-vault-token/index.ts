...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token
...
export interface EphemeralVaultTokenConfig extends cdktn.TerraformEphemeralMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#display_name EphemeralVaultToken#display_name}
  */
  readonly displayName?: string;
  /**
  * Name of the entity alias to associate with during token creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#entity_alias EphemeralVaultToken#entity_alias}
  */
  readonly entityAlias?: string;
  /**
  * The explicit max TTL of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#explicit_max_ttl EphemeralVaultToken#explicit_max_ttl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#id EphemeralVaultToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#metadata EphemeralVaultToken#metadata}
  */
  readonly metadata?: { [key: string]: string };
  /**
  * Terraform ID of the mount resource. Used to defer the provisioning of the ephemeral resource till the apply stage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#mount_id EphemeralVaultToken#mount_id}
  */
  readonly mountId?: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#namespace EphemeralVaultToken#namespace}
  */
  readonly namespace?: string;
  /**
  * Flag to disable the default policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#no_default_policy EphemeralVaultToken#no_default_policy}
  */
  readonly noDefaultPolicy?: boolean | cdktn.IResolvable;
  /**
  * Flag to create a token without parent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#no_parent EphemeralVaultToken#no_parent}
  */
  readonly noParent?: boolean | cdktn.IResolvable;
  /**
  * The number of allowed uses of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#num_uses EphemeralVaultToken#num_uses}
  */
  readonly numUses?: number;
  /**
  * The period of the token for periodic tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#period EphemeralVaultToken#period}
  */
  readonly period?: string;
  /**
  * List of policies to attach to the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#policies EphemeralVaultToken#policies}
  */
  readonly policies?: string[];
  /**
  * Flag to allow the token to be renewed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#renewable EphemeralVaultToken#renewable}
  */
  readonly renewable?: boolean | cdktn.IResolvable;
  /**
  * The token role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#role_name EphemeralVaultToken#role_name}
  */
  readonly roleName?: string;
  /**
  * The TTL period of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#ttl EphemeralVaultToken#ttl}
  */
  readonly ttl?: string;
  /**
  * The token type. Can be 'batch' or 'service'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#type EphemeralVaultToken#type}
  */
  readonly type?: string;
  /**
  * The TTL period of the wrapped token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token#wrapping_ttl EphemeralVaultToken#wrapping_ttl}
  */
  readonly wrappingTtl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token vault_token}
*/
export class EphemeralVaultToken extends cdktn.TerraformEphemeralResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/ephemeral-resources/token vault_token} Ephemeral Resource
  *
