...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/ad_secret_library
...
export class AdSecretLibrary extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AdSecretLibrary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/ad_secret_library#import import section} in the documentation of this resource for the id to use
