...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/pki_secret_backend_keys
...
export class DataVaultPkiSecretBackendKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultPkiSecretBackendKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/pki_secret_backend_keys#import import section} in the documentation of this resource for the id to use
