...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/oci_auth_backend_role
...
export interface OciAuthBackendRoleConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class OciAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OciAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/oci_auth_backend_role#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OciAuthBackendRole to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_oci_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/oci_auth_backend_role vault_oci_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ocid_list: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ocidList),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ocid_list: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._ocidList),
        isBlock: false,
        type: "list",
