...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/cf_auth_backend_config
...
export class CfAuthBackendConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CfAuthBackendConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/cf_auth_backend_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/cf_auth_backend_config vault_cf_auth_backend_config} Resource
  *
  * @param scope The scope in which to define this construct
