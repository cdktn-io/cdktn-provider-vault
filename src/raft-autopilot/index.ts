...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/raft_autopilot
...
export class RaftAutopilot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RaftAutopilot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/raft_autopilot#import import section} in the documentation of this resource for the id to use
