...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/secrets_sync_gh_destination
...
export class SecretsSyncGhDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsSyncGhDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/secrets_sync_gh_destination#import import section} in the documentation of this resource for the id to use
