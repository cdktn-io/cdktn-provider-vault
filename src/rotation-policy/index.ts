...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/rotation_policy
...
export class RotationPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RotationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/rotation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/rotation_policy vault_rotation_policy} Resource
  *
  * @param scope The scope in which to define this construct
