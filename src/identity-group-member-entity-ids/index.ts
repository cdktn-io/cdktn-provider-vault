...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/identity_group_member_entity_ids
...
export class IdentityGroupMemberEntityIds extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityGroupMemberEntityIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/identity_group_member_entity_ids#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/identity_group_member_entity_ids vault_identity_group_member_entity_ids} Resource
  *
  * @param scope The scope in which to define this construct
