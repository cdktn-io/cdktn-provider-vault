...
// https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/resources/cert_auth_backend_role
...
export class CertAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CertAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/resources/cert_auth_backend_role#import import section} in the documentation of this resource for the id to use
