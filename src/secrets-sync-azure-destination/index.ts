...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/secrets_sync_azure_destination
...
export class SecretsSyncAzureDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsSyncAzureDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/secrets_sync_azure_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/secrets_sync_azure_destination vault_secrets_sync_azure_destination} Resource
  *
  * @param scope The scope in which to define this construct
