...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime
...
export interface PluginRuntimeConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#cgroup_parent PluginRuntime#cgroup_parent}
  */
  readonly cgroupParent?: string;
  /**
  * Specifies CPU limit to set per container in billionths of a CPU.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#cpu_nanos PluginRuntime#cpu_nanos}
  */
  readonly cpuNanos?: number;
  /**
  * Specifies memory limit to set per container in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#memory_bytes PluginRuntime#memory_bytes}
  */
  readonly memoryBytes?: number;
  /**
  * The name of the plugin runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#name PluginRuntime#name}
  */
  readonly name: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#namespace PluginRuntime#namespace}
  */
  readonly namespace?: string;
  /**
  * Specifies OCI-compliant container runtime to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#oci_runtime PluginRuntime#oci_runtime}
  */
  readonly ociRuntime?: string;
  /**
  * Whether the container runtime is running as a non-privileged user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#rootless PluginRuntime#rootless}
  */
  readonly rootless?: boolean | cdktn.IResolvable;
  /**
  * Specifies the plugin runtime type. Currently only `container` is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#type PluginRuntime#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime vault_plugin_runtime}
*/
export class PluginRuntime extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PluginRuntime that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/plugin_runtime vault_plugin_runtime} Resource
  *
  * @param scope The scope in which to define this construct
