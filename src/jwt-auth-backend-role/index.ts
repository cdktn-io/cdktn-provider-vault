...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/jwt_auth_backend_role
...
export class JwtAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing JwtAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/jwt_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/jwt_auth_backend_role vault_jwt_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
