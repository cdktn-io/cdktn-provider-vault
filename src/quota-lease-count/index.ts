...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/quota_lease_count
...
export class QuotaLeaseCount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaLeaseCount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/quota_lease_count#import import section} in the documentation of this resource for the id to use
