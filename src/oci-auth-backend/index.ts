...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/oci_auth_backend
...
export class OciAuthBackend extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OciAuthBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/oci_auth_backend#import import section} in the documentation of this resource for the id to use
