...
// https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/audit
...
export class Audit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Audit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/audit#import import section} in the documentation of this resource for the id to use
