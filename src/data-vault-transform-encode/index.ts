...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/transform_encode
...
export class DataVaultTransformEncode extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultTransformEncode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/transform_encode#import import section} in the documentation of this resource for the id to use
