...
// https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/data-sources/kv_secret_v2
...
export class DataVaultKvSecretV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultKvSecretV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/data-sources/kv_secret_v2#import import section} in the documentation of this resource for the id to use
