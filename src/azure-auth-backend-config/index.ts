...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/azure_auth_backend_config
...
export interface AzureAuthBackendConfigConfig extends cdktn.TerraformMetaArguments {
  /**
  * The authentication method used by Vault to access Azure APIs. The following values are supported: root_creds, plugin_wif, msi, aks_wif. plugin_wif requires Vault Enterprise.
  *
...
export class AzureAuthBackendConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureAuthBackendConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/azure_auth_backend_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/azure_auth_backend_config vault_azure_auth_backend_config} Resource
  *
  * @param scope The scope in which to define this construct
