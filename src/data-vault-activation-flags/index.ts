...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/activation_flags
...
export class DataVaultActivationFlags extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultActivationFlags that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/activation_flags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/activation_flags vault_activation_flags} Data Source
  *
  * @param scope The scope in which to define this construct
