...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_backend
...
export interface KmipSecretBackendConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class KmipSecretBackend extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmipSecretBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_backend#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the KmipSecretBackend to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_kmip_secret_backend", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/kmip_secret_backend vault_kmip_secret_backend} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // listen_addrs - computed: false, optional: true, required: false
  private _listenAddrs?: string[]; 
  public get listenAddrs() {
    return cdktn.Fn.tolist(this.getListAttribute('listen_addrs'));
  }
  ...
  public get serverHostnames() {
    return cdktn.Fn.tolist(this.getListAttribute('server_hostnames'));
  }
  ...
  public get serverIps() {
    return cdktn.Fn.tolist(this.getListAttribute('server_ips'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      default_tls_client_key_bits: cdktn.numberToTerraform(this._defaultTlsClientKeyBits),
      default_tls_client_key_type: cdktn.stringToTerraform(this._defaultTlsClientKeyType),
      default_tls_client_ttl: cdktn.numberToTerraform(this._defaultTlsClientTtl),
      ...
      listen_addrs: cdktn.listMapper(cdktn.stringToTerraform, false)(this._listenAddrs),
      ...
      tls_ca_key_bits: cdktn.numberToTerraform(this._tlsCaKeyBits),
      tls_ca_key_type: cdktn.stringToTerraform(this._tlsCaKeyType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      default_tls_client_key_bits: {
        value: cdktn.numberToHclTerraform(this._defaultTlsClientKeyBits),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      default_tls_client_key_type: {
        value: cdktn.stringToHclTerraform(this._defaultTlsClientKeyType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      default_tls_client_ttl: {
        value: cdktn.numberToHclTerraform(this._defaultTlsClientTtl),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      listen_addrs: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._listenAddrs),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      tls_ca_key_bits: {
        value: cdktn.numberToHclTerraform(this._tlsCaKeyBits),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      tls_ca_key_type: {
        value: cdktn.stringToHclTerraform(this._tlsCaKeyType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
