...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/scep_auth_backend_role
...
export interface ScepAuthBackendRoleConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ScepAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ScepAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/scep_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_scep_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/scep_auth_backend_role vault_scep_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      challenge: cdktn.stringToTerraform(this._challenge),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      challenge: {
        value: cdktn.stringToHclTerraform(this._challenge),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
