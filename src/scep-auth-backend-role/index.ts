...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/scep_auth_backend_role
...
export class ScepAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ScepAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/scep_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/scep_auth_backend_role vault_scep_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
