...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_login
...
export class ApproleAuthBackendLogin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApproleAuthBackendLogin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_login#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/approle_auth_backend_login vault_approle_auth_backend_login} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      secret_id_wo: this.markWriteOnlyAttribute(cdktn.stringToTerraform(this._secretIdWo)),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      secret_id_wo: {
        value: this.markWriteOnlyAttribute(cdktn.stringToHclTerraform(this._secretIdWo)),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
