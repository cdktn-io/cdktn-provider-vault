...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/raft_autopilot_state
...
export class DataVaultRaftAutopilotState extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultRaftAutopilotState that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/raft_autopilot_state#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/raft_autopilot_state vault_raft_autopilot_state} Data Source
  *
  * @param scope The scope in which to define this construct
