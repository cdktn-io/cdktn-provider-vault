...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/keymgmt_aws_kms
...
export class KeymgmtAwsKms extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KeymgmtAwsKms that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/keymgmt_aws_kms#import import section} in the documentation of this resource for the id to use
