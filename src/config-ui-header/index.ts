...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_ui_header
...
export class ConfigUiHeader extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigUiHeader that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_ui_header#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/config_ui_header vault_config_ui_header} Resource
  *
  * @param scope The scope in which to define this construct
