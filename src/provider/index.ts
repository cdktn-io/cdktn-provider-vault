...
// https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs
...
export class VaultProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing VaultProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#import import section} in the documentation of this resource for the id to use
