...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs
...
export interface VaultProviderAuthLoginJwt {
  ...
  */
  readonly distributedClaimAccessToken?: string;
  /**
  * A signed JSON Web Token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs#jwt VaultProvider#jwt}
...
export function vaultProviderAuthLoginJwtToTerraform(struct?: VaultProviderAuthLoginJwt | cdktn.IResolvable): any {
  ...
  return {
    distributed_claim_access_token: cdktn.stringToTerraform(struct!.distributedClaimAccessToken),
    jwt: cdktn.stringToTerraform(struct!.jwt),
    mount: cdktn.stringToTerraform(struct!.mount),
    namespace: cdktn.stringToTerraform(struct!.namespace),
    role: cdktn.stringToTerraform(struct!.role),
...
export function vaultProviderAuthLoginJwtToHclTerraform(struct?: VaultProviderAuthLoginJwt | cdktn.IResolvable): any {
  ...
  const attrs = {
    distributed_claim_access_token: {
      value: cdktn.stringToHclTerraform(struct!.distributedClaimAccessToken),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class VaultProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing VaultProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs vault} Resource
  *
  * @param scope The scope in which to define this construct
