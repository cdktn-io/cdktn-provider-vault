...
// https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/approle_auth_backend_role_id
...
export class DataVaultApproleAuthBackendRoleId extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultApproleAuthBackendRoleId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/approle_auth_backend_role_id#import import section} in the documentation of this resource for the id to use
