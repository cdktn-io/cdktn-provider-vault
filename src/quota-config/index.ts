...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/quota_config
...
export class QuotaConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/quota_config#import import section} in the documentation of this resource for the id to use
