...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config
...
export interface QuotaConfigConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#absolute_rate_limit_exempt_paths QuotaConfig#absolute_rate_limit_exempt_paths}
  */
  readonly absoluteRateLimitExemptPaths?: string[];
  /**
  * Enables audit logging for requests rejected by rate limit quotas.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#enable_rate_limit_audit_logging QuotaConfig#enable_rate_limit_audit_logging}
  */
  readonly enableRateLimitAuditLogging?: boolean | cdktn.IResolvable;
  /**
  * Enables rate limit response headers on HTTP responses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#enable_rate_limit_response_headers QuotaConfig#enable_rate_limit_response_headers}
  */
  readonly enableRateLimitResponseHeaders?: boolean | cdktn.IResolvable;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#namespace QuotaConfig#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#rate_limit_exempt_paths QuotaConfig#rate_limit_exempt_paths}
  */
  readonly rateLimitExemptPaths?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config vault_quota_config}
*/
export class QuotaConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/quota_config vault_quota_config} Resource
  *
  * @param scope The scope in which to define this construct
