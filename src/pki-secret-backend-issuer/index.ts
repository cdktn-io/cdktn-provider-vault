...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_issuer
...
*/
export class PkiSecretBackendIssuer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PkiSecretBackendIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_issuer#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_pki_secret_backend_issuer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_issuer vault_pki_secret_backend_issuer} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _disableCriticalExtensionChecks?: boolean | cdktn.IResolvable; 
  public get disableCriticalExtensionChecks() {
    return this.getBooleanAttribute('disable_critical_extension_checks');
  }
  public set disableCriticalExtensionChecks(value: boolean | cdktn.IResolvable) {
  ...
  private _disableNameChecks?: boolean | cdktn.IResolvable; 
  public get disableNameChecks() {
    return this.getBooleanAttribute('disable_name_checks');
  }
  public set disableNameChecks(value: boolean | cdktn.IResolvable) {
  ...
  private _disableNameConstraintChecks?: boolean | cdktn.IResolvable; 
  public get disableNameConstraintChecks() {
    return this.getBooleanAttribute('disable_name_constraint_checks');
  }
  public set disableNameConstraintChecks(value: boolean | cdktn.IResolvable) {
  ...
  private _disablePathLengthChecks?: boolean | cdktn.IResolvable; 
  public get disablePathLengthChecks() {
    return this.getBooleanAttribute('disable_path_length_checks');
  }
  public set disablePathLengthChecks(value: boolean | cdktn.IResolvable) {
  ...
  private _enableAiaUrlTemplating?: boolean | cdktn.IResolvable; 
  public get enableAiaUrlTemplating() {
    return this.getBooleanAttribute('enable_aia_url_templating');
  }
  public set enableAiaUrlTemplating(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      crl_distribution_points: cdktn.listMapper(cdktn.stringToTerraform, false)(this._crlDistributionPoints),
      disable_critical_extension_checks: cdktn.booleanToTerraform(this._disableCriticalExtensionChecks),
      disable_name_checks: cdktn.booleanToTerraform(this._disableNameChecks),
      disable_name_constraint_checks: cdktn.booleanToTerraform(this._disableNameConstraintChecks),
      disable_path_length_checks: cdktn.booleanToTerraform(this._disablePathLengthChecks),
      enable_aia_url_templating: cdktn.booleanToTerraform(this._enableAiaUrlTemplating),
      id: cdktn.stringToTerraform(this._id),
      issuer_name: cdktn.stringToTerraform(this._issuerName),
      issuer_ref: cdktn.stringToTerraform(this._issuerRef),
      issuing_certificates: cdktn.listMapper(cdktn.stringToTerraform, false)(this._issuingCertificates),
      leaf_not_after_behavior: cdktn.stringToTerraform(this._leafNotAfterBehavior),
      manual_chain: cdktn.listMapper(cdktn.stringToTerraform, false)(this._manualChain),
      namespace: cdktn.stringToTerraform(this._namespace),
      ocsp_servers: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ocspServers),
      revocation_signature_algorithm: cdktn.stringToTerraform(this._revocationSignatureAlgorithm),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      crl_distribution_points: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._crlDistributionPoints),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      disable_critical_extension_checks: {
        value: cdktn.booleanToHclTerraform(this._disableCriticalExtensionChecks),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      disable_name_checks: {
        value: cdktn.booleanToHclTerraform(this._disableNameChecks),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      disable_name_constraint_checks: {
        value: cdktn.booleanToHclTerraform(this._disableNameConstraintChecks),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      disable_path_length_checks: {
        value: cdktn.booleanToHclTerraform(this._disablePathLengthChecks),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      enable_aia_url_templating: {
        value: cdktn.booleanToHclTerraform(this._enableAiaUrlTemplating),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      issuing_certificates: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._issuingCertificates),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      leaf_not_after_behavior: {
        value: cdktn.stringToHclTerraform(this._leafNotAfterBehavior),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      manual_chain: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._manualChain),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      ocsp_servers: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._ocspServers),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      revocation_signature_algorithm: {
        value: cdktn.stringToHclTerraform(this._revocationSignatureAlgorithm),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
