...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/jwt_auth_backend
...
export class JwtAuthBackend extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing JwtAuthBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/jwt_auth_backend#import import section} in the documentation of this resource for the id to use
