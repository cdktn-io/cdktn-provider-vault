...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/data-sources/transform_decode
...
export interface DataVaultTransformDecodeConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataVaultTransformDecode extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultTransformDecode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/data-sources/transform_decode#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_transform_decode", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/data-sources/transform_decode vault_transform_decode} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      decoded_value: cdktn.stringToTerraform(this._decodedValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      decoded_value: {
        value: cdktn.stringToHclTerraform(this._decodedValue),
        isBlock: false,
        type: "simple",
