...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/generic_secret
...
export class GenericSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GenericSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/generic_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/generic_secret vault_generic_secret} Resource
  *
  * @param scope The scope in which to define this construct
