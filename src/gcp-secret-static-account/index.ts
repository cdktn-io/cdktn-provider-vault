...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/gcp_secret_static_account
...
export class GcpSecretStaticAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpSecretStaticAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/gcp_secret_static_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/gcp_secret_static_account vault_gcp_secret_static_account} Resource
  *
  * @param scope The scope in which to define this construct
