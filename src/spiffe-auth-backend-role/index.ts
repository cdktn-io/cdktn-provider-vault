...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_role
...
export interface SpiffeAuthBackendRoleConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class SpiffeAuthBackendRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SpiffeAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "vault_spiffe_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/spiffe_auth_backend_role vault_spiffe_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      workload_id_patterns: cdktn.listMapper(cdktn.stringToTerraform, false)(this._workloadIdPatterns),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      workload_id_patterns: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._workloadIdPatterns),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
