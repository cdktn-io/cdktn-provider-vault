...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/agent_registration
...
export class AgentRegistration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/agent_registration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/agent_registration vault_agent_registration} Resource
  *
  * @param scope The scope in which to define this construct
