...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/pki_secret_backend_config_cmpv2
...
export class DataVaultPkiSecretBackendConfigCmpv2AuthenticatorsOutputReference extends cdktn.ComplexObject {
...
export class DataVaultPkiSecretBackendConfigCmpv2AuthenticatorsList extends cdktn.ComplexList {
...
*/
export class DataVaultPkiSecretBackendConfigCmpv2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultPkiSecretBackendConfigCmpv2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/pki_secret_backend_config_cmpv2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/pki_secret_backend_config_cmpv2 vault_pki_secret_backend_config_cmpv2} Data Source
  *
  * @param scope The scope in which to define this construct
