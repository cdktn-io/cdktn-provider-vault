...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_azure_kms
...
export class KeymgmtAzureKms extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KeymgmtAzureKms that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_azure_kms#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/keymgmt_azure_kms vault_keymgmt_azure_kms} Resource
  *
  * @param scope The scope in which to define this construct
