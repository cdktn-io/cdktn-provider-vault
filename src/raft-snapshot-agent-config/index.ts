...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/raft_snapshot_agent_config
...
export interface RaftSnapshotAgentConfigConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly autoloadEnabled?: boolean | cdktn.IResolvable;
  /**
  * AWS access key ID.
  *
  ...
  */
  readonly awsSecretAccessKeyWo?: string;
  /**
  * AWS session token.
  *
...
export class RaftSnapshotAgentConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RaftSnapshotAgentConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/raft_snapshot_agent_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/raft_snapshot_agent_config vault_raft_snapshot_agent_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: RaftSnapshotAgentConfigConfig) {
    ...
    this._autoloadEnabled = config.autoloadEnabled;
    ...
    this._awsSecretAccessKeyWo = config.awsSecretAccessKeyWo;
    ...
    this._azureAuthMode = config.azureAuthMode;
    ...
    this._secretsWoVersion = config.secretsWoVersion;
  ...
  // autoload_enabled - computed: false, optional: true, required: false
  private _autoloadEnabled?: boolean | cdktn.IResolvable; 
  public get autoloadEnabled() {
    return this.getBooleanAttribute('autoload_enabled');
  }
  public set autoloadEnabled(value: boolean | cdktn.IResolvable) {
    this._autoloadEnabled = value;
  }
  public resetAutoloadEnabled() {
    this._autoloadEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get autoloadEnabledInput() {
  ...
  */
  ...
  public set awsSecretAccessKeyWo(value: string) {
    this._awsSecretAccessKeyWo = value;
  }
  public resetAwsSecretAccessKeyWo() {
    this._awsSecretAccessKeyWo = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get awsSecretAccessKeyWoInput() {
    return this._awsSecretAccessKeyWo;
  }
  ...
  // azure_auth_mode - computed: false, optional: true, required: false
  private _azureAuthMode?: string; 
  public get azureAuthMode() {
    return this.getStringAttribute('azure_auth_mode');
  }
  public set azureAuthMode(value: string) {
    this._azureAuthMode = value;
  }
  public resetAzureAuthMode() {
    this._azureAuthMode = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get azureAuthModeInput() {
    return this._azureAuthMode;
  }
  ...
  // file_prefix - computed: true, optional: true, required: false
  ...
  // secrets_wo_version - computed: true, optional: true, required: false
  private _secretsWoVersion?: number; 
  public get secretsWoVersion() {
    return this.getNumberAttribute('secrets_wo_version');
  }
  public set secretsWoVersion(value: number) {
    this._secretsWoVersion = value;
  }
  public resetSecretsWoVersion() {
    this._secretsWoVersion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get secretsWoVersionInput() {
    return this._secretsWoVersion;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      autoload_enabled: cdktn.booleanToTerraform(this._autoloadEnabled),
      ...
      azure_auth_mode: cdktn.stringToTerraform(this._azureAuthMode),
      ...
      secrets_wo_version: cdktn.numberToTerraform(this._secretsWoVersion),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      autoload_enabled: {
        value: cdktn.booleanToHclTerraform(this._autoloadEnabled),
        isBlock: false,
        type: "simple",
      ...
      azure_auth_mode: {
        value: cdktn.stringToHclTerraform(this._azureAuthMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      secrets_wo_version: {
        value: cdktn.numberToHclTerraform(this._secretsWoVersion),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
