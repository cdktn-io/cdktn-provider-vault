...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/raft_snapshot_agent_config
...
export class RaftSnapshotAgentConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RaftSnapshotAgentConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/raft_snapshot_agent_config#import import section} in the documentation of this resource for the id to use
