...
// https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/ldap_secret_backend_dynamic_role
...
export class LdapSecretBackendDynamicRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LdapSecretBackendDynamicRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/ldap_secret_backend_dynamic_role#import import section} in the documentation of this resource for the id to use
