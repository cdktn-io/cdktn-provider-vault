...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account
...
export interface OsSecretBackendAccountConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#custom_metadata OsSecretBackendAccount#custom_metadata}
  */
  readonly customMetadata?: { [key: string]: string };
  /**
  * Disable automated password rotation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#disable_automated_rotation OsSecretBackendAccount#disable_automated_rotation}
  */
  readonly disableAutomatedRotation?: boolean | cdktn.IResolvable;
  /**
  * Name of the host this account belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#host OsSecretBackendAccount#host}
  */
  readonly host: string;
  /**
  * Path where the OS secrets backend is mounted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#mount OsSecretBackendAccount#mount}
  */
  readonly mount: string;
  /**
  * Name of the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#name OsSecretBackendAccount#name}
  */
  readonly name: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#namespace OsSecretBackendAccount#namespace}
  */
  readonly namespace?: string;
  /**
  * Reference to a parent account for rotation management.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#parent_account_ref OsSecretBackendAccount#parent_account_ref}
  */
  readonly parentAccountRef?: string;
  /**
  * Name of the password policy to use for password generation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#password_policy OsSecretBackendAccount#password_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#password_wo OsSecretBackendAccount#password_wo}
  */
  readonly passwordWo: string;
  /**
  * How often to rotate passwords, in seconds. Mutually exclusive with rotation_schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#rotation_period OsSecretBackendAccount#rotation_period}
  */
  readonly rotationPeriod?: number;
  /**
  * Cron schedule for password rotation. Mutually exclusive with rotation_period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#rotation_schedule OsSecretBackendAccount#rotation_schedule}
  */
  readonly rotationSchedule?: string;
  /**
  * Window of time for password rotation, in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#rotation_window OsSecretBackendAccount#rotation_window}
  */
  readonly rotationWindow?: number;
  /**
  * Username for the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#username OsSecretBackendAccount#username}
  */
  readonly username: string;
  /**
  * Verify the connection to the host with the provided credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#verify_connection OsSecretBackendAccount#verify_connection}
  */
  readonly verifyConnection?: boolean | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account vault_os_secret_backend_account}
*/
export class OsSecretBackendAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OsSecretBackendAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/resources/os_secret_backend_account vault_os_secret_backend_account} Resource
  *
  * @param scope The scope in which to define this construct
