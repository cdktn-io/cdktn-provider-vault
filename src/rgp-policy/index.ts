...
// https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/rgp_policy
...
export class RgpPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RgpPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/rgp_policy#import import section} in the documentation of this resource for the id to use
