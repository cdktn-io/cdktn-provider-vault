...
// https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/kubernetes_auth_backend_config
...
export interface DataVaultKubernetesAuthBackendConfigConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataVaultKubernetesAuthBackendConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultKubernetesAuthBackendConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/kubernetes_auth_backend_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.12.0/docs/data-sources/kubernetes_auth_backend_config vault_kubernetes_auth_backend_config} Data Source
  *
  * @param scope The scope in which to define this construct
