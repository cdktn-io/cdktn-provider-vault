...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/egp_policy
...
export class EgpPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EgpPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/egp_policy#import import section} in the documentation of this resource for the id to use
