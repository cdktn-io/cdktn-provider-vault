...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/auth_backends
...
export class DataVaultAuthBackends extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultAuthBackends that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/auth_backends#import import section} in the documentation of this resource for the id to use
