...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/policy
...
export class Policy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Policy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/policy#import import section} in the documentation of this resource for the id to use
