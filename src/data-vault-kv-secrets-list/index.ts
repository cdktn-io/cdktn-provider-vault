...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/kv_secrets_list
...
export class DataVaultKvSecretsList extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultKvSecretsList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/kv_secrets_list#import import section} in the documentation of this resource for the id to use
