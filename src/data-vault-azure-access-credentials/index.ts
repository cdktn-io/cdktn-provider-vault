...
// https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/azure_access_credentials
...
export class DataVaultAzureAccessCredentials extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultAzureAccessCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/azure_access_credentials#import import section} in the documentation of this resource for the id to use
