...
// https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/kubernetes_auth_backend_role
...
export class DataVaultKubernetesAuthBackendRole extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultKubernetesAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/kubernetes_auth_backend_role#import import section} in the documentation of this resource for the id to use
