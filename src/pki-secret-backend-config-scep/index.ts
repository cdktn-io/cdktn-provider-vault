...
// https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_config_scep
...
export class PkiSecretBackendConfigScep extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PkiSecretBackendConfigScep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_config_scep#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/pki_secret_backend_config_scep vault_pki_secret_backend_config_scep} Resource
  *
  * @param scope The scope in which to define this construct
