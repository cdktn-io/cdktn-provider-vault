...
# CDKTN prebuilt bindings for hashicorp/vault provider version 5.11.0

This repo builds and publishes the [Terraform vault provider](https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform vault provider](https://registry.terraform.io/providers/hashicorp/vault/5.11.0)
