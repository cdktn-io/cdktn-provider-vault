...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/genericendpoint"
...
| <code><a href="#@cdktn/provider-vault.genericEndpoint.GenericEndpointConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/generic_endpoint#id GenericEndpoint#id}. |
