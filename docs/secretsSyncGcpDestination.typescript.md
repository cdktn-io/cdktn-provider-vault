...
| <code><a href="#@cdktn/provider-vault.secretsSyncGcpDestination.SecretsSyncGcpDestination.property.replicaRegionsInput">replicaRegionsInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.secretsSyncGcpDestination.SecretsSyncGcpDestination.property.replicaRegions">replicaRegions</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.secretsSyncGcpDestination.SecretsSyncGcpDestinationConfig.property.replicaRegions">replicaRegions</a></code> | <code>{[ key: string ]: string}</code> | Map of regions to KMS key resource names for replica region encryption. KMS key values are optional. |
