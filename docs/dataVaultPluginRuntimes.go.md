...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v18/datavaultpluginruntimes"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/data-sources/plugin_runtimes#import import section} in the documentation of this resource for the id to use
