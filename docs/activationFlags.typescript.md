...
```typescript
import { activationFlags } from '@cdktn/provider-vault'

new activationFlags.ActivationFlags(scope: Construct, id: string, config: ActivationFlagsConfig)
```
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.Initializer.parameter.id">id</a></code> | <code>string</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.Initializer.parameter.config">config</a></code> | <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig">ActivationFlagsConfig</a></code> | *No description.* |
...
##### `config`<sup>Required</sup> <a name="config" id="@cdktn/provider-vault.activationFlags.ActivationFlags.Initializer.parameter.config"></a>

- *Type:* <a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig">ActivationFlagsConfig</a>
...
activationFlags.ActivationFlags.isConstruct(x: any)
```
...
activationFlags.ActivationFlags.isTerraformElement(x: any)
```
...
activationFlags.ActivationFlags.isTerraformResource(x: any)
```
...
activationFlags.ActivationFlags.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.terraformResourceType">terraformResourceType</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.dependsOn">dependsOn</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.featureInput">featureInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.feature">feature</a></code> | <code>string</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlags.property.tfResourceType">tfResourceType</a></code> | <code>string</code> | *No description.* |
...
const activationFlagsConfig: activationFlags.ActivationFlagsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.activationFlags.ActivationFlagsConfig.property.feature">feature</a></code> | <code>string</code> | Exact feature key to activate with PUT /sys/activation-flags/:feature/activate. |
