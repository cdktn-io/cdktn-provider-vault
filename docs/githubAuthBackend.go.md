...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/githubauthbackend"
...
| <code><a href="#@cdktn/provider-vault.githubAuthBackend.GithubAuthBackendConfig.property.tune">Tune</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/github_auth_backend#tune GithubAuthBackend#tune}. |
