...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/approleauthbackendrole"
...
| <code><a href="#@cdktn/provider-vault.approleAuthBackendRole.ApproleAuthBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/approle_auth_backend_role#id ApproleAuthBackendRole#id}. |
