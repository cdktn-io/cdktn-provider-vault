...
```typescript
import { configUiHeader } from '@cdktn/provider-vault'

new configUiHeader.ConfigUiHeader(scope: Construct, id: string, config: ConfigUiHeaderConfig)
```
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.Initializer.parameter.id">id</a></code> | <code>string</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.Initializer.parameter.config">config</a></code> | <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig">ConfigUiHeaderConfig</a></code> | *No description.* |
...
##### `config`<sup>Required</sup> <a name="config" id="@cdktn/provider-vault.configUiHeader.ConfigUiHeader.Initializer.parameter.config"></a>

- *Type:* <a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig">ConfigUiHeaderConfig</a>
...
configUiHeader.ConfigUiHeader.isConstruct(x: any)
```
...
configUiHeader.ConfigUiHeader.isTerraformElement(x: any)
```
...
configUiHeader.ConfigUiHeader.isTerraformResource(x: any)
```
...
configUiHeader.ConfigUiHeader.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.terraformResourceType">terraformResourceType</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.dependsOn">dependsOn</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.nameInput">nameInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.valuesInput">valuesInput</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.name">name</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.values">values</a></code> | <code>string[]</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeader.property.tfResourceType">tfResourceType</a></code> | <code>string</code> | *No description.* |
...
const configUiHeaderConfig: configUiHeader.ConfigUiHeaderConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.name">name</a></code> | <code>string</code> | The name of the custom header. Cannot start with `X-Vault-`. |
| <code><a href="#@cdktn/provider-vault.configUiHeader.ConfigUiHeaderConfig.property.values">values</a></code> | <code>string[]</code> | Set of values for the header. At least one value is required. Duplicates are automatically ignored. |
