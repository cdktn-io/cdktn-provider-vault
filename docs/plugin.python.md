...
| <code><a href="#@cdktn/provider-vault.plugin.Plugin.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/plugin#id Plugin#id}. |
...
| <code><a href="#@cdktn/provider-vault.plugin.Plugin.resetCommand">reset_command</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-vault.plugin.Plugin.resetSha256">reset_sha256</a></code> | *No description.* |
...
##### `reset_command` <a name="reset_command" id="@cdktn/provider-vault.plugin.Plugin.resetCommand"></a>
...
##### `reset_sha256` <a name="reset_sha256" id="@cdktn/provider-vault.plugin.Plugin.resetSha256"></a>
...
| <code><a href="#@cdktn/provider-vault.plugin.PluginConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.11.0/docs/resources/plugin#id Plugin#id}. |
