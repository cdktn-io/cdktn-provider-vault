...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v16/datavaultpkisecretbackendcertmetadata"
...
| <code><a href="#@cdktn/provider-vault.dataVaultPkiSecretBackendCertMetadata.DataVaultPkiSecretBackendCertMetadataConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/data-sources/pki_secret_backend_cert_metadata#id DataVaultPkiSecretBackendCertMetadata#id}. |
