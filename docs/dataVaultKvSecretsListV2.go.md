...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v16/datavaultkvsecretslistv2"
...
| <code><a href="#@cdktn/provider-vault.dataVaultKvSecretsListV2.DataVaultKvSecretsListV2Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/data-sources/kv_secrets_list_v2#id DataVaultKvSecretsListV2#id}. |
