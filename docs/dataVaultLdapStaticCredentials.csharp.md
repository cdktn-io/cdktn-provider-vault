...
| <code><a href="#@cdktn/provider-vault.dataVaultLdapStaticCredentials.DataVaultLdapStaticCredentials.property.rotatedOnRead">RotatedOnRead</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable RotatedOnRead { get; }
```
