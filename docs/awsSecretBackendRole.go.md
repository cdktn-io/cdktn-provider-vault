...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/awssecretbackendrole"
...
| <code><a href="#@cdktn/provider-vault.awsSecretBackendRole.AwsSecretBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/aws_secret_backend_role#id AwsSecretBackendRole#id}. |
