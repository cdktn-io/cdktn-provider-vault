...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v16/pkisecretbackendcert"
...
| <code><a href="#@cdktn/provider-vault.pkiSecretBackendCert.PkiSecretBackendCertConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.8.0/docs/resources/pki_secret_backend_cert#id PkiSecretBackendCert#id}. |
