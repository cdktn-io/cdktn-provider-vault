...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v16/quotaconfig"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/quota_config#import import section} in the documentation of this resource for the id to use
