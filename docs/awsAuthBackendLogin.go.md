...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/awsauthbackendlogin"
...
| <code><a href="#@cdktn/provider-vault.awsAuthBackendLogin.AwsAuthBackendLoginConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/aws_auth_backend_login#id AwsAuthBackendLogin#id}. |
