...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/identityoidcrole"
...
| <code><a href="#@cdktn/provider-vault.identityOidcRole.IdentityOidcRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/identity_oidc_role#id IdentityOidcRole#id}. |
