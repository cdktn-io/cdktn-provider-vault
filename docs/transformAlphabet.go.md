...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v16/transformalphabet"
...
| <code><a href="#@cdktn/provider-vault.transformAlphabet.TransformAlphabetConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/transform_alphabet#id TransformAlphabet#id}. |
