...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/datavaulttransitcmac"
...
| <code><a href="#@cdktn/provider-vault.dataVaultTransitCmac.DataVaultTransitCmacConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/data-sources/transit_cmac#id DataVaultTransitCmac#id}. |
