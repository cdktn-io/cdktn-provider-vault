...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/datavaultkvsecretv2"
...
| <code><a href="#@cdktn/provider-vault.dataVaultKvSecretV2.DataVaultKvSecretV2Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/data-sources/kv_secret_v2#id DataVaultKvSecretV2#id}. |
