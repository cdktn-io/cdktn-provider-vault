...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/datavaultpkisecretbackendkeys"
...
| <code><a href="#@cdktn/provider-vault.dataVaultPkiSecretBackendKeys.DataVaultPkiSecretBackendKeysConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/data-sources/pki_secret_backend_keys#id DataVaultPkiSecretBackendKeys#id}. |
