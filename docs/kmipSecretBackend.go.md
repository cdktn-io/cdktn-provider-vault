...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/kmipsecretbackend"
...
| <code><a href="#@cdktn/provider-vault.kmipSecretBackend.KmipSecretBackendConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/kmip_secret_backend#id KmipSecretBackend#id}. |
