...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/mfaduo"
...
| <code><a href="#@cdktn/provider-vault.mfaDuo.MfaDuoConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/mfa_duo#id MfaDuo#id}. |
