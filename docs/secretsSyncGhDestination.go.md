...
```go
import "github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/secretssyncghdestination"
...
| <code><a href="#@cdktn/provider-vault.secretsSyncGhDestination.SecretsSyncGhDestinationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/secrets_sync_gh_destination#id SecretsSyncGhDestination#id}. |
